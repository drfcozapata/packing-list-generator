	...
	<table class="w-full table-fixed">
		<thead class="bg-slate-700 text-white font-semibold">
			<tr>
				...
				<td class="w-[15%] text-center px-3 -pt-2 pb-3 border align-top">Total Precio</td>
			</tr>
		</thead>
		<tbody>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity1" class="w-full px-2 pb-2 text-center" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity1, price1).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity2" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity2, price2).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity3" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity3, price3).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity4" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity4, price4).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity5" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity5, price5).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity6" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity6, price6).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity7" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity7, price7).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity8" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity8, price8).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				<td class="w-[15%] border-b-[1px] border-l-[1px]">
					<input type="number" v-model="quantity9" class="w-full px-2 pb-2 text-center" />
				</td>
				<td class="w-[55%] border-b-[1px] border-l-[1px]">
					<input type="text" class="w-full px-3 pb-2" />
				</td>
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity9, price9).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity10, price10).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity11, price11).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity12, price12).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity13, price13).toFixed(2) }}
					</p>
				</td>
			</tr>
			<tr class="w-full">
				...
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-right pr-5 pb-3">
						{{ sum(quantity14, price14).toFixed(2) }}
					</p>
				</td>
			</tr>
			<!-- Totalization file -->
			<tr class="w-full">
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
					<p class="text-center font-semibold pb-[10px]">
						{{ sumQuantities() }}
					</p>
				</td>
				<td class="w-[55%]">
					<p class="text-center font-semibold pb-2">TOTAL</p>
				</td>
				<td class="w-[15%]">
					<input type="text" name="price" class="w-full px-3 pb-2 text-right" />
				</td>
				<td class="w-[15%] border-l-[1px] border-b-[1px] border-r-[1px]">
